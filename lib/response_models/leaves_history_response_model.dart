...
// =================================================Lead History Response Model=========================================
class LeadHistoryResponseModel {
  ...
  factory LeadHistoryResponseModel.fromJson(Map<String, dynamic> json){
    return LeadHistoryResponseModel(
      actionBy: json["action_by"],
      changeTimestamp: json["change_timestamp"],
      actionMessage: json["action_message"],
      fieldChanges: json["field_changes"] == null ? [] : List<String>.from(json["field_changes"]!.map((x) => x)),
