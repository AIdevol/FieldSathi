...
class TechnicianResponseModel {
  ...
  factory TechnicianResponseModel.fromJson(Map<String, dynamic> json) {
    return TechnicianResponseModel(
      ...
      results: List<TechnicianData>.from(json['results'].map((x) => TechnicianData.fromJson(x))),
    );
  }
...
class TodayAttendance {
  ...
  factory TodayAttendance.fromJson(Map<String, dynamic> json) {
    return TodayAttendance(
      ...
      endTime: json['end_time'] != null
          ...
          : null,
      status: json['status'], // Parsing status field
    );
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'start_time': startTime != null ? _timeOfDayToString(startTime!) : null,
      'end_time': endTime != null ? _timeOfDayToString(endTime!) : null,
      'status': status, // Serializing status field
    };
  }
