...
import '../controller/calender_view_amc_controller.dart';
...
class CalendarView extends GetView<CalenderViewAmcController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CalenderViewAmcController>(
